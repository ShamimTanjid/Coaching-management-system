...
@section('main-conternt')
    <!--Content Start-->
        ...
        <div class="row ">
            <div class="col-sm-12 pl-0 pr-0 content">
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <select name="school_id" class="form-control col-sm-8" id="school" required>
                            ...
                            @foreach($schools as $schoolses)
                              <option value="{{$schoolses->id}}">{{$schoolses->schoolname}}</option>
                            @endforeach
                        </select>
                        <span class="text-danger"></span>
                    </div>
                 ...
                 <div class="form-group col-md-6 mb-3">
                         <label for="classId" class="col-sm-4 col-form-label text-right">Class Name
                            </label>
                          
                        <select name="class_id" class="form-control col-sm-8" id="classId" required>
                                  <option value="">Select Class</option>
                             @foreach($classes as $classeses)
                                  <option value="{{$classeses->id}}">{{$classeses->classname}}</option>
                             @endforeach
                         </select>
                          <span class="text-danger"></span>
                   </div>
