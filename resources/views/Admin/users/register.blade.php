    ...
    <form method="POST" action="{{route('user-save')}}" enctype="multipart/form-data" autocomplete="" class="form-inline">
            ...
            <div class="form-group col-12 mb-3">
              <label for="role" class="col-sm-3 col-form-label text-right">Role</label>
                ...
                <select name="role" class="form-control col-sm-9 @error('role') is-invalid @enderror" id="role"value="{{ old('role') }}" placeholder="Name" required autofocus>
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="password" type="password" class="col-sm-9 form-control @error('password') is-invalid @enderror" name="password" required  placeholder="Password">
