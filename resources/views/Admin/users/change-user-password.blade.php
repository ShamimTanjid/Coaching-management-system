...
<section class="container-fluid">
    ...
    <form method="POST" action="{{route('user-password-update')}}" enctype="multipart/form-data" autocomplete="" class="form-inline">
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="password" type="password" class="col-sm-9 form-control @error('password') is-invalid @enderror" name="password" required  placeholder="oldPassword">
                ...
                <div class="form-group col-12 mb-3">
                    <label for="NewPassword" class="col-sm-3 col-form-label text-right">NewPassword</label>
                    <input id="newpassword" type="password" class="col-sm-9 form-control @error('password') is-invalid @enderror" name="newpassword" placeholder="New Password" required>
                                @error('newpassword')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
