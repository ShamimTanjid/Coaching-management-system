                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('schoolname') is-invalid @enderror" name="schoolname" id="school_name" placeholder="Write School Name Here" value="{{ old('schoolname') }}" required>
                                            @error('schoolname')
